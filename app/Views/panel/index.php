...
<main class="flex-1 p-6 overflow-y-auto">
    <div class="grid grid-cols-4  lg:grid-cols-6 gap-6 h-full content-start">
        ...
        <a href="<?= base_url('mesas') ?>"
            class="bg-white border-b-4 border-teal-500 rounded-2xl shadow-md active:scale-95 active:bg-teal-50 transition-all p-6 flex flex-col items-center justify-center gap-4 h-36 group">
            <div
                class="w-16 h-16 bg-teal-100 text-teal-600 rounded-full flex items-center justify-center text-3xl group-hover:scale-110 transition-transform">
                🪑
            </div>
            <span class="text-lg font-bold text-gray-700">Mesas y Pisos</span>
        </a>
