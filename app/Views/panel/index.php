...
<?= $this->section('content') ?>
    ...
    <main class="flex-1 p-6 overflow-y-auto">
        <div class="grid grid-cols-4  lg:grid-cols-6 gap-6 h-full content-start">
            ...
            <!-- BOTÓN VOLVER -->
             <a href="<?= base_url('venta') ?>" class="bg-slate-700 border-b-4 border-slate-900 rounded-2xl shadow-md active:scale-95 active:bg-slate-600 transition-all p-6 flex flex-col items-center justify-center gap-4 h-36 group">
