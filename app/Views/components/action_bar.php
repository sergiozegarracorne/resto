...
<section class="h-[22vh] bg-orange-100  border-t-8 border-orange-300 p-6 z-20">
    <div class="grid grid-cols-5 gap-3 h-full px-2">
        <button
            ...
            <span class="text-2xl group-hover:scale-110 transition-transform filter grayscale group-hover:grayscale-0">❌</span>
        ...
        <button
            ...
            <span class="text-2xl group-hover:scale-110 transition-transform filter grayscale group-hover:grayscale-0">🍽️</span>
